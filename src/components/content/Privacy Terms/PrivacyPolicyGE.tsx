...
const PrivacyGe: React.FC = () => {
  return (
    <div className="container">
      <h1>Datenschutzerklärung</h1>
      Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz
      hat einen besonders hohen Stellenwert für die Geschäftsleitung der Sandra
      Thomas und Marcel Rödiger GbR. Eine Nutzung der Internetseiten der Sandra
      Thomas und Marcel Rödiger GbR ist grundsätzlich ohne jede Angabe
      ...
      ein. Die Verarbeitung personenbezogener Daten, beispielsweise des Namens,
      ...
      Übereinstimmung mit den für die Sandra Thomas und Marcel Rödiger GbR
      ...
      aufgeklärt. Die Sandra Thomas und Marcel Rödiger GbR hat als für die
      ...
      beispielsweise telefonisch, an uns zu übermitteln. 1. Begriffsbestimmungen
      Die Datenschutzerklärung der Sandra Thomas und Marcel Rödiger GbR beruht
      ...
      die verwendeten Begrifflichkeiten erläutern. Wir verwenden in dieser
      ...
      betroffene Person Betroffene Person ist jede identifizierte oder
      identifizierbare natürliche Person, deren personenbezogene Daten von dem
      für die Verarbeitung Verantwortlichen verarbeitet werden. c) Verarbeitung
      ...
      die Verknüpfung, die Einschränkung, das Löschen oder die Vernichtung. d)
      ...
      künftige Verarbeitung einzuschränken. e) Profiling Profiling ist jede Art
      ...
      natürlichen Person zu analysieren oder vorherzusagen. f) Pseudonymisierung
      ...
      vorgesehen werden. h) Auftragsverarbeiter Auftragsverarbeiter ist eine
      natürliche oder juristische Person, Behörde, Einrichtung oder andere
      Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen
      verarbeitet. i) Empfänger Empfänger ist eine natürliche oder juristische
      ...
      jedoch nicht als Empfänger. j) Dritter Dritter ist eine natürliche oder
      ...
      verarbeiten. k) Einwilligung Einwilligung ist jede von der betroffenen
      ...
      Anschrift des für die Verarbeitung Verantwortlichen Verantwortlicher im
      ...
      Bestimmungen mit datenschutzrechtlichem Charakter ist die: Sandra Thomas
      und Marcel Rödiger GbR Graf-Zeppelin-Straße 32 31157 Sarstedt
      Niedersachsen Deutschland Tel.: +4915122301610 E-Mail:
      info@network-levelup.com Website: www.network-levelup.com 3. Cookies Die
      Internetseiten der Sandra Thomas und Marcel Rödiger GbR verwenden Cookies.
      ...
      die Sandra Thomas und Marcel Rödiger GbR den Nutzern dieser Internetseite
      ...
      nutzbar. 4. Erfassung von allgemeinen Daten und Informationen Die
      Internetseite der Sandra Thomas und Marcel Rödiger GbR erfasst mit jedem
      ...
      auf unsere Internetseite gelangt (sogenannte Referrer), (4) die
      ...
      dienen. Bei der Nutzung dieser allgemeinen Daten und Informationen zieht
      die Sandra Thomas und Marcel Rödiger GbR keine Rückschlüsse auf die
      ...
      erhobenen Daten und Informationen werden durch die Sandra Thomas und
      Marcel Rödiger GbR daher einerseits statistisch und ferner mit dem Ziel
      ...
      betroffene Person angegebenen personenbezogenen Daten gespeichert. 5.
      Registrierung auf unserer Internetseite Die betroffene Person hat die
      Möglichkeit, sich auf der Internetseite des für die Verarbeitung
      ...
      nutzt. Durch eine Registrierung auf der Internetseite des für die
      ...
      unseres Newsletters Auf der Internetseite der Sandra Thomas und Marcel
      Rödiger GbR wird den Benutzern die Möglichkeit eingeräumt, den Newsletter
      unseres Unternehmens zu abonnieren. Welche personenbezogenen Daten bei der
      ...
      Die Sandra Thomas und Marcel Rödiger GbR informiert ihre Kunden und
      ...
      Newsletter-Tracking Die Newsletter der Sandra Thomas und Marcel Rödiger
      GbR enthalten sogenannte Zählpixel. Ein Zählpixel ist eine Miniaturgrafik,
      die in solche E-Mails eingebettet wird, welche im HTML-Format versendet
      werden, um eine Logdatei-Aufzeichnung und eine Logdatei-Analyse zu
      ermöglichen. Dadurch kann eine statistische Auswertung des Erfolges oder
      Misserfolges von Online-Marketing-Kampagnen durchgeführt werden. Anhand
      des eingebetteten Zählpixels kann die Sandra Thomas und Marcel Rödiger GbR
      ...
      Person aufgerufen wurden. Solche über die in den Newslettern enthaltenen
      ...
      Erhalt des Newsletters deutet die Sandra Thomas und Marcel Rödiger GbR
      automatisch als Widerruf. 8. Routinemäßige Löschung und Sperrung von
      personenbezogenen Daten Der für die Verarbeitung Verantwortliche
      ...
      Vorschriften gesperrt oder gelöscht. 9. Rechte der betroffenen Person a)
      Recht auf Bestätigung Jede betroffene Person hat das vom Europäischen
      ...
      Verantwortlichen wenden. b) Recht auf Auskunft Jede von der Verarbeitung
      ...
      Empfängern in Drittländern oder bei internationalen Organisationen falls
      ...
      die Festlegung dieser Dauer das Bestehen eines Rechts auf Berichtigung
      ...
      Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. c) Recht auf
      ...
      einer ergänzenden Erklärung — zu verlangen. Möchte eine betroffene Person
      dieses Berichtigungsrecht in Anspruch nehmen, kann sie sich hierzu
      jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
      wenden. d) Recht auf Löschung (Recht auf Vergessen werden) Jede von der
      ...
      Weise verarbeitet, für welche sie nicht mehr notwendig sind. Die
      ...
      unrechtmäßig verarbeitet. Die Löschung der personenbezogenen Daten ist zur
      ...
      die Löschung von personenbezogenen Daten, die bei der Sandra Thomas und
      Marcel Rödiger GbR gespeichert sind, veranlassen möchte, kann sie sich
      hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
      Verantwortlichen wenden. Der Mitarbeiter der Sandra Thomas und Marcel
      Rödiger GbR wird veranlassen, dass dem Löschverlangen unverzüglich
      nachgekommen wird. Wurden die personenbezogenen Daten von der Sandra
      Thomas und Marcel Rödiger GbR öffentlich gemacht und ist unser Unternehmen
      als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
      personenbezogenen Daten verpflichtet, so trifft die Sandra Thomas und
      Marcel Rödiger GbR unter Berücksichtigung der verfügbaren Technologie und
      ...
      erforderlich ist. Der Mitarbeiter der Sandra Thomas und Marcel Rödiger GbR
      wird im Einzelfall das Notwendige veranlassen. e) Recht auf Einschränkung
      der Verarbeitung Jede von der Verarbeitung personenbezogener Daten
      ...
      Voraussetzungen gegeben ist: Die Richtigkeit der personenbezogenen Daten
      ...
      stattdessen die Einschränkung der Nutzung der personenbezogenen Daten. Der
      ...
      bei der Sandra Thomas und Marcel Rödiger GbR gespeichert sind, verlangen
      möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
      Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Sandra Thomas
      und Marcel Rödiger GbR wird die Einschränkung der Verarbeitung
      veranlassen. f) Recht auf Datenübertragbarkeit Jede von der Verarbeitung
      personenbezogener Daten betroffene Person hat das vom Europäischen
      ...
      Mitarbeiter der Sandra Thomas und Marcel Rödiger GbR wenden. g) Recht auf
      ...
      gestütztes Profiling. Die Sandra Thomas und Marcel Rödiger GbR verarbeitet
      ...
      Ausübung oder Verteidigung von Rechtsansprüchen. Verarbeitet die Sandra
      Thomas und Marcel Rödiger GbR personenbezogene Daten, um Direktwerbung zu
      ...
      Person gegenüber der Sandra Thomas und Marcel Rödiger GbR der Verarbeitung
      für Zwecke der Direktwerbung, so wird die Sandra Thomas und Marcel Rödiger
      GbR die personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten.
      ...
      personenbezogener Daten, die bei der Sandra Thomas und Marcel Rödiger GbR
      ...
      im öffentlichen Interesse liegenden Aufgabe erforderlich. Zur Ausübung des
      Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden
      Mitarbeiter der Sandra Thomas und Marcel Rödiger GbR oder einen anderen
      ...
      verwendet werden. h) Automatisierte Entscheidungen im Einzelfall
      ...
      betroffenen Person, trifft die Sandra Thomas und Marcel Rödiger GbR
      ...
      gehört. Möchte die betroffene Person Rechte mit Bezug auf automatisierte
      Entscheidungen geltend machen, kann sie sich hierzu jederzeit an einen
      Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. i) Recht auf
      ...
      Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. 10.
      Datenschutz bei Bewerbungen und im Bewerbungsverfahren Der für die
      Verarbeitung Verantwortliche erhebt und verarbeitet die personenbezogenen
      Daten von Bewerbern zum Zwecke der Abwicklung des Bewerbungsverfahrens.
      Die Verarbeitung kann auch auf elektronischem Wege erfolgen. Dies ist
      ...
      E-Mail oder über ein auf der Internetseite befindliches Webformular, an
      den für die Verarbeitung Verantwortlichen übermittelt. Schließt der für
      die Verarbeitung Verantwortliche einen Anstellungsvertrag mit einem
      ...
      Sonstiges berechtigtes Interesse in diesem Sinne ist beispielsweise eine
      Beweispflicht in einem Verfahren nach dem Allgemeinen
      Gleichbehandlungsgesetz (AGG). 11. Datenschutzbestimmungen zu Einsatz und
      Verwendung von Facebook Der für die Verarbeitung Verantwortliche hat auf
      dieser Internetseite Komponenten des Unternehmens Facebook integriert.
      Facebook ist ein soziales Netzwerk. Ein soziales Netzwerk ist ein im
      Internet betriebener sozialer Treffpunkt, eine Online-Gemeinschaft, die es
      den Nutzern in der Regel ermöglicht, untereinander zu kommunizieren und im
      ...
      und eine Vernetzung über Freundschaftsanfragen. Betreibergesellschaft von
      Facebook ist die Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025, USA.
      Für die Verarbeitung personenbezogener Daten Verantwortlicher ist, wenn
      eine betroffene Person außerhalb der USA oder Kanada lebt, die Facebook
      Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2,
      Ireland. Durch jeden Aufruf einer der Einzelseiten dieser Internetseite,
      die durch den für die Verarbeitung Verantwortlichen betrieben wird und auf
      welcher eine Facebook-Komponente (Facebook-Plug-In) integriert wurde, wird
      ...
      Facebook herunterzuladen. Eine Gesamtübersicht über alle Facebook-Plug-Ins
      kann unter https://developers.facebook.com/docs/plugins/?locale=de_DE
      ...
      Facebook zu unterdrücken. 12. Datenschutzbestimmungen zu Einsatz und
      Verwendung von Google AdSense Der für die Verarbeitung Verantwortliche hat
      auf dieser Internetseite Google AdSense integriert. Google AdSense ist ein
      Online-Dienst, über welchen eine Vermittlung von Werbung auf Drittseiten
      ermöglicht wird. Google AdSense beruht auf einem Algorithmus, welcher die
      auf Drittseiten angezeigten Werbeanzeigen passend zu den Inhalten der
      ...
      Betreibergesellschaft der Google-AdSense-Komponente ist die Google Ireland
      Limited, Gordon House, Barrow Street, Dublin, D04 E5W5, Ireland. Der Zweck
      der Google-AdSense-Komponente ist die Einbindung von Werbeanzeigen auf
      ...
      eine Google-AdSense-Komponente integriert wurde, wird der Internetbrowser
      ...
      Daten zum Zwecke der Online-Werbung und der Abrechnung von Provisionen an
      die Alphabet Inc. zu übermitteln. Im Rahmen dieses technischen Verfahrens
      erhält die Alphabet Inc. Kenntnis über personenbezogene Daten, wie der
      IP-Adresse der betroffenen Person, die der Alphabet Inc. unter anderem
      dazu dienen, die Herkunft der Besucher und Klicks nachzuvollziehen und in
      der Folge Provisionsabrechnungen zu ermöglichen. Die betroffene Person
      ...
      anderem dazu, den Besucherfluss einer Internetseite auszuwerten. Über
      Google AdSense werden personenbezogene Daten und Informationen, was auch
      die IP-Adresse umfasst und zur Erfassung und Abrechnung der angezeigten
      Werbeanzeigen notwendig ist, an die Alphabet Inc. in die Vereinigten
      Staaten von Amerika übertragen. Diese personenbezogenen Daten werden in
      den Vereinigten Staaten von Amerika gespeichert und verarbeitet. Die
      Alphabet Inc. gibt diese über das technische Verfahren erhobenen
      personenbezogenen Daten unter Umständen an Dritte weiter. Google-AdSense
      wird unter diesem Link https://www.google.de/intl/de/adsense/start/
      genauer erläutert. 13. Datenschutzbestimmungen zu Einsatz und Verwendung
      von Google Analytics (mit Anonymisierungsfunktion) Der für die
      ...
      https://www.google.com/intl/de_de/analytics/ genauer erläutert. 14.
      ...
      Werbeanzeigen anzeigen zu lassen. Betreibergesellschaft der Dienste von
      Google Remarketing ist die Google Ireland Limited, Gordon House, Barrow
      Street, Dublin, D04 E5W5, Ireland. Zweck von Google Remarketing ist die
      Einblendung von interessenrelevanter Werbung. Google Remarketing
      ermöglicht es uns, Werbeanzeigen über das Google-Werbenetzwerk anzuzeigen
      oder auf anderen Internetseiten anzeigen zu lassen, welche auf die
      individuellen Bedürfnisse und Interessen von Internetnutzern abgestimmt
      sind. Google Remarketing setzt ein Cookie auf dem
      informationstechnologischen System der betroffenen Person. Was Cookies
      sind, wurde oben bereits erläutert. Mit der Setzung des Cookies wird
      Google eine Wiedererkennung des Besuchers unserer Internetseite
      ermöglicht, wenn dieser in der Folge Internetseiten aufruft, die ebenfalls
      Mitglied des Google-Werbenetzwerks sind. Mit jedem Aufruf einer
      Internetseite, auf welcher der Dienst von Google Remarketing integriert
      wurde, identifiziert sich der Internetbrowser der betroffenen Person
      automatisch bei Google. Im Rahmen dieses technischen Verfahrens erhält
      Google Kenntnis über personenbezogene Daten, wie der IP-Adresse oder des
      Surfverhaltens des Nutzers, welche Google unter anderem zur Einblendung
      interessenrelevanter Werbung verwendet. Mittels des Cookies werden
      ...
      IP-Adresse des von der betroffenen Person genutzten Internetanschlusses,
      ...
      Amerika gespeichert. Google gibt diese über das technische Verfahren
      ...
      Setzung von Cookies dauerhaft widersprechen. Eine solche Einstellung des
      genutzten Internetbrowsers würde auch verhindern, dass Google ein Cookie
      auf dem informationstechnologischen System der betroffenen Person setzt.
      Zudem kann ein von Google Analytics bereits gesetzter Cookie jederzeit
      über den Internetbrowser oder andere Softwareprogramme gelöscht werden.
      ...
      Link www.google.de/settings/ads aufrufen und dort die gewünschten
      Einstellungen vornehmen. Weitere Informationen und die geltenden
      Datenschutzbestimmungen von Google können unter
      https://www.google.de/intl/de/policies/privacy/ abgerufen werden. 15.
      Datenschutzbestimmungen zu Einsatz und Verwendung von Google-AdWords Der
      für die Verarbeitung Verantwortliche hat auf dieser Internetseite Google
      AdWords integriert. Google AdWords ist ein Dienst zur Internetwerbung, der
      es Werbetreibenden gestattet, sowohl Anzeigen in den
      ...
      eines automatischen Algorithmus und unter Beachtung der zuvor festgelegten
      ...
      Der Zweck von Google AdWords ist die Bewerbung unserer Internetseite durch
      die Einblendung von interessenrelevanter Werbung auf den Internetseiten
      von Drittunternehmen und in den Suchmaschinenergebnissen der Suchmaschine
      ...
      AdWords-Anzeige zu ermitteln und um unsere AdWords-Anzeigen für die
      Zukunft zu optimieren. Weder unser Unternehmen noch andere Werbekunden von
      ...
      https://www.google.de/intl/de/policies/privacy/ abgerufen werden. 16.
      Datenschutzbestimmungen zu Einsatz und Verwendung von Instagram Der für
      die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten
      des Dienstes Instagram integriert. Instagram ist ein Dienst, der als
      audiovisuelle Plattform zu qualifizieren ist und den Nutzern das Teilen
      von Fotos und Videos und zudem eine Weiterverbreitung solcher Daten in
      anderen sozialen Netzwerken ermöglicht. Betreibergesellschaft der Dienste
      von Instagram ist die Facebook Ireland Ltd., 4 Grand Canal Square, Grand
      Canal Harbour, Dublin 2 Ireland. Durch jeden Aufruf einer der Einzelseiten
      ...
      und von Instagram gespeichert und verarbeitet. Instagram erhält über die
      Instagram-Komponente immer dann eine Information darüber, dass die
      betroffene Person unsere Internetseite besucht hat, wenn die betroffene
      Person zum Zeitpunkt des Aufrufs unserer Internetseite gleichzeitig bei
      Instagram eingeloggt ist; dies findet unabhängig davon statt, ob die
      ...
      https://www.instagram.com/about/legal/privacy/ abgerufen werden. 17.
      Datenschutzbestimmungen zu Einsatz und Verwendung von LinkedIn Der für die
      ...
      https://www.linkedin.com/legal/cookie-policy abrufbar. 18.
      Datenschutzbestimmungen zu Einsatz und Verwendung von Xing Der für die
      ...
      https://www.xing.com/app/share?op=data_protection Datenschutzhinweise für
      den XING-Share-Button veröffentlicht. 19. Datenschutzbestimmungen zu
      Einsatz und Verwendung von YouTube Der für die Verarbeitung
      ...
      Daten durch YouTube und Google. 20. Zahlungsart: Datenschutzbestimmungen
      zu PayPal als Zahlungsart Der für die Verarbeitung Verantwortliche hat auf
      ...
      Käuferschutzdienste an. Die Europäische Betreibergesellschaft von PayPal
      ist die PayPal (Europe) S.à.r.l. et Cie, S.C.A., 22-24 Boulevard Royal
      L-2449, Luxemburg. Wählt die betroffene Person während des Bestellvorgangs
      in unserem Online-Shop als Zahlungsmöglichkeit „PayPal“ aus, werden
      automatisiert Daten der betroffenen Person an PayPal übermittelt. Mit der
      Auswahl dieser Zahlungsoption willigt die betroffene Person in die zur
      ...
      mit der jeweiligen Bestellung stehen. Die Übermittlung der Daten bezweckt
      ...
      übermitteln, wenn ein berechtigtes Interesse für die Übermittlung gegeben
      ist. Die zwischen PayPal und dem für die Verarbeitung Verantwortlichen
      ausgetauschten personenbezogenen Daten werden von PayPal unter Umständen
      an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung bezweckt die
      Identitäts- und Bonitätsprüfung. PayPal gibt die personenbezogenen Daten
      ...
      werden sollen. Die betroffene Person hat die Möglichkeit, die Einwilligung
      zum Umgang mit personenbezogenen Daten jederzeit gegenüber PayPal zu
      widerrufen. Ein Widerruf wirkt sich nicht auf personenbezogene Daten aus,
      die zwingend zur (vertragsgemäßen) Zahlungsabwicklung verarbeitet, genutzt
      oder übermittelt werden müssen. Die geltenden Datenschutzbestimmungen von
      PayPal können unter https://www.paypal.com/de/webapps/mpp/ua/privacy-full
      abgerufen werden. 21. Rechtsgrundlage der Verarbeitung Art. 6 I lit. a
      DS-GVO dient unserem Unternehmen als Rechtsgrundlage für
      ...
      (Erwägungsgrund 47 Satz 2 DS-GVO). 22. Berechtigte Interessen an der
      ...
      unserer Anteilseigner. 23. Dauer, für die die personenbezogenen Daten
      ...
      Vertragsanbahnung erforderlich sind. 24. Gesetzliche oder vertragliche
      ...
      Nichtbereitstellung der personenbezogenen Daten hätte. 25. Bestehen einer
      automatisierten Entscheidungsfindung Als verantwortungsbewusstes
      Unternehmen verzichten wir auf eine automatische Entscheidungsfindung oder
      ein Profiling.
    </div>
  );
};
export default PrivacyGe;
